...
- **Multiple conversation sequences**: onboarding, tutorial, support, and main menu
...
- **Services**: 
  - `ChatService` for loading chat sequences, managing conversation flow, cross-sequence navigation, and handling user interactions
...
- **Assets**: 
  ...
  - Each sequence supports branching conversations, choices, text input, cross-sequence navigation, and storage keys
...
- **Modular Conversations**: Organized conversation flows for onboarding, tutorials, support, and navigation
...
8. Access the User Variables Panel by tapping the person icon in the AppBar to view stored data
9. Begin development by following TDD principles and updating relevant models, services, or widgets
10. **Sequence system**: Add new conversation flows by creating JSON files in `assets/sequences/`
11. **Modular architecture**: Components are organized in `lib/widgets/chat_screen/` for easy maintenance
...
#### Sequence System Implementation (Latest - December 2024)
