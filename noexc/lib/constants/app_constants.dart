...
class AppConstants {
  ...
  static const List<String> availableSequences = ['onboarding', 'tutorial', 'support', 'menu', 'autoroute_test','custom_value_demo', 'comparison_demo', 'multi_text_demo', 'test_single_responsibility', 'comprehensive_test'];
