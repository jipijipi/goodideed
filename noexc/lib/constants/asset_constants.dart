...
class AssetConstants {
  ...
  static const String onboardingSequence = '${_sequencesPath}onboarding_seq.json';
  static const String taskCheckingSequence = '${_sequencesPath}taskChecking_seq.json';
  static const String taskSettingSequence = '${_sequencesPath}taskSetting_seq.json';
  ...
  static const String taskConfigSequence = '${_sequencesPath}task_config_seq.json';
  static const String taskConfigTestSequence = '${_sequencesPath}task_config_test_seq.json';
  static const String dayTrackingTestSequence = '${_sequencesPath}day_tracking_test_seq.json';
  ...
  // Illustration assets
  static const String illustrationEmpty = '${_imagesPath}illustrations/empty_state.svg';
  static const String illustrationError = '${_imagesPath}illustrations/error_state.svg';
  static const String illustrationSuccess = '${_imagesPath}illustrations/success_state.svg';
  static const String illustrationOnboarding = '${_imagesPath}illustrations/onboarding.svg';

  // Background assets
  static const String backgroundPattern = '${_imagesPath}backgrounds/pattern.png';
  static const String backgroundGradient = '${_imagesPath}backgrounds/gradient.png';
