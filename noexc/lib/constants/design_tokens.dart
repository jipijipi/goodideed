...
class DesignTokens {
  ...
  static const Color botMessageBackgroundLight = Color.fromARGB(
    150,
    255,
    255,
    255,
  ); // Full opacity white
  static const Color botMessageBackgroundLightWithAlpha = Color.fromARGB(
    80,
    255,
    255,
    255,
  ); // 80% white for alpha variant
  ...
  static const Color selectedChoiceColorLight = Color.fromARGB(
    220,
    255,
    255,
    255,
  ...
  static const Color unselectedChoiceBorderLight = Color.fromARGB(
    128,
    255,
    255,
    255,
  ...
  static const Color disabledChoiceColorLight = Color.fromARGB(
    0,
    255,
    255,
    255,
  );
  static const Color disabledChoiceTextLight = Color.fromARGB(
    50,
    10,
    10,
    20,
  ...
  static const Color selectedChoiceColorDark =
      darkPrimary; // Brand blue dark #6B6FA3
  ...
  static const Color unselectedChoiceColorDark = Color(
    0x4D6B6FA3,
  ); // 30% brand blue dark
  static const Color unselectedChoiceTextDark = Color(0x99FFFFFF); // 60% white
  static const Color unselectedChoiceBorderDark = Color(
    0x806B6FA3,
  ); // 50% brand blue dark

  /// Disabled Choice Button Colors - Dark Theme (with direct alpha - most muted)
  static const Color disabledChoiceColorDark = Color(
    0x1A6B6FA3,
  ); // 10% brand blue dark
  static const Color disabledChoiceTextDark = Color(0x4DFFFFFF); // 30% white
  static const Color disabledChoiceBorderDark = Color.fromARGB(
    20,
    107,
    111,
    163,
  ...
  static const Color primaryButtonBackgroundLight = Color.fromARGB(
    255,
    223,
    218,
    57,
  ...
  static const Color secondaryButtonBackgroundLight = Color.fromARGB(
    255,
    16,
    158,
    183,
  ...
  static const Color inputBackgroundLight = Color.fromARGB(
    255,
    255,
    255,
    255,
  ...
  /// Input Border Colors
  static const Color inputBorderColorLight = Color.fromARGB(
    0,
    72,
    75,
    133,
  ); // Brand blue #484B85
  static const Color inputBorderColorDark =
      darkPrimary; // Brand blue dark #6B6FA3
  ...
  /// Input Text Colors
  static const Color inputTextColorLight =
      brandBlack; // Dark text on light input
  static const Color inputTextColorDark =
      Colors.white; // Light text on dark input
  ...
  static const Color selectedChoiceShadowColorDark = Color(
    0x4D000000,
  ); // 30% black
  ...
  static const Color unselectedChoiceShadowColorDark = Color(
    0x33000000,
  ); // 20% black

  /// Disabled Choice Shadow Properties (minimal - flat)
  static const Color disabledChoiceShadowColorLight = Color.fromARGB(
    0,
    255,
    255,
    255,
  ); // 10% brand blue
  static const Color disabledChoiceShadowColorDark = Color(
    0x1A000000,
  ); // 10% black

  /// Shadow Offset Properties
  static const Offset selectedChoiceShadowOffset = Offset(
    0,
    0,
  ); // Most pronounced
  ...
  static const double unselectedChoiceShadowBlurRadius =
      0.0; // Moderate elevation
  ...
  static const bool showAvatars =
      false; // Toggle to hide/show all avatars for testing
  ...
  static const Duration messageSlideAnimationDuration = Duration(
    milliseconds: 350,
  );
  ...
  static const EdgeInsets chatListPadding = EdgeInsets.fromLTRB(
    spaceL,
    chatListTopPadding,
    spaceL,
    spaceL,
  ...
  static const EdgeInsets debugCardContentPadding = EdgeInsets.symmetric(
    horizontal: spaceM,
    vertical: spaceS,
  );
  static const EdgeInsets debugButtonPadding = EdgeInsets.symmetric(
    horizontal: spaceS,
    vertical: spaceXS,
  );
  static const EdgeInsets statusMessagePadding = EdgeInsets.symmetric(
    horizontal: spaceS,
    vertical: spaceXS,
  );
  ...
  static const EdgeInsets statusMessageMargin = EdgeInsets.only(
    bottom: spaceXS,
  );
  ...
  static MarkdownStyleSheet getMessageMarkdownStyle(
    BuildContext context, {
    required bool isBot,
  }) {
    final textColor = isBot ? botMessageTextColor : userMessageTextColor;

    return MarkdownStyleSheet(
      // Base text style
      p: TextStyle(fontSize: messageFontSize, color: textColor, height: 1.4),
      // Bold text
      strong: TextStyle(
      ...
      code: TextStyle(fontSize: messageFontSize, color: textColor),
  ...
  static MarkdownStyleSheet getChoiceMarkdownStyle(
    ...
    return MarkdownStyleSheet(
      ...
      p: TextStyle(
        ...
        height: 1.4,
        decoration:
            state == ChoiceState.disabled ? TextDecoration.lineThrough : null,
