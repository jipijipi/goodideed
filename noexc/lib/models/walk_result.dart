...
class WalkResult {
  ...
  bool get requiresUserInteraction => stopReason == WalkStopReason.interactiveMessage;
  
  /// Whether this result requires a sequence transition
  bool get requiresSequenceTransition => stopReason == WalkStopReason.sequenceBoundary;
