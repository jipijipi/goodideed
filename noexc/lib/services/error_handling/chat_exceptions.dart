...
class ChatSequenceException extends ChatException {
  ...
  @override
  String toString() =>
      'ChatSequenceException: $message (Sequence: $sequenceId)';
}
...
class ChatMessageException extends ChatException {
  ...
  @override
  String toString() =>
      'ChatMessageException: $message (Message ID: $messageId)';
}
...
class ChatConditionException extends ChatException {
  ...
  @override
  String toString() =>
      'ChatConditionException: $message (Condition: $condition)';
}
...
class ChatFlowException extends ChatException {
  ...
  @override
  String toString() =>
      'ChatFlowException: $message (Description: $description)';
}
...
class ChatAssetException extends ChatException {
  ...
  const ChatAssetException(super.message, {required super.type, this.asset});
