...
class VariantFileValidator {
  ...
  Future<List<ValidationError>> validateVariantFiles(ChatSequence sequence) async {
  ...
  Future<List<ValidationError>> validateVariantContent(ChatSequence sequence) async {
    final warnings = <ValidationError>[];
