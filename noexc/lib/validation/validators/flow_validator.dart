...
class FlowValidator {
  ...
  void _dfsCircularCheck(
    ...
    if (message != null) {
      // Check next message
      if (message.nextMessageId != null) {
        _dfsCircularCheck(sequence, message.nextMessageId!, visited, path, circularPaths);
      }
      ...
      if (message.choices != null) {
        for (final choice in message.choices!) {
          if (choice.nextMessageId != null) {
            _dfsCircularCheck(sequence, choice.nextMessageId!, visited, path, circularPaths);
          }
        }
      }
      ...
      if (message.routes != null) {
        for (final route in message.routes!) {
          if (route.nextMessageId != null) {
            _dfsCircularCheck(sequence, route.nextMessageId!, visited, path, circularPaths);
          }
        }
      }
    }
