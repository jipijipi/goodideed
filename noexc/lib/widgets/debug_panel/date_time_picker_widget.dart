...
class _DateTimePickerWidgetState extends State<DateTimePickerWidget> {
  ...
  Future<void> _loadCurrentValues() async {
    final taskDate = await widget.userDataService.getValue<String>(
      StorageKeys.taskCurrentDate,
    );
    final isActiveDay = await widget.userDataService.getValue<bool>(
      StorageKeys.taskIsActiveDay,
    );
    final isPastDeadline = await widget.userDataService.getValue<bool>(
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(
                DesignTokens.debugButtonRadius,
              ),
            ),
            child: Text(
              value,
  ...
  Future<void> _setToYesterday() async {
    ...
    widget.statusController?.addSuccess(
      'Task date set to yesterday (for testing)',
    );
  }
