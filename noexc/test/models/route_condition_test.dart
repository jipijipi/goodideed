...
void main() {
  group('RouteCondition', () {
    test('should create RouteCondition from JSON', () {
      // Arrange
      final json = {'condition': 'user.age >= 18', 'nextMessageId': 10};
    ...
    test('should create default RouteCondition from JSON', () {
      // Arrange
      final json = {'default': true, 'nextMessageId': 20};
    ...
    test('should support equality comparison', () {
      // Arrange
      final route1 = RouteCondition(
        condition: 'user.age >= 21',
        nextMessageId: 25,
      );
      final route2 = RouteCondition(
        condition: 'user.age >= 21',
        nextMessageId: 25,
      );
      final route3 = RouteCondition(
