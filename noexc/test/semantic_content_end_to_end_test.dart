...
void main() {
  group('Semantic Content System End-to-End', () {
    ...
    test(
      'should process message with semantic contentKey through MessageProcessor',
      () async {
    ...
    test('should handle choice messages with contentKey', () async {
      ...
      expect(
        ...
        equals('user.greet.character.friendly'),
      );
      expect(
        processed.choices![1].contentKey,
        equals('user.greet.character.skeptical'),
      );
    });

    test(
      'should fall back to original text when no content file exists',
      () async {
        final message = ChatMessage(
          id: 4,
    ...
    test(
      'should work seamlessly with legacy messages without contentKey',
      () async {
        final message = ChatMessage(
          id: 5,
