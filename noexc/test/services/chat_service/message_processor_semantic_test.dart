  ...
  group('MessageProcessor Semantic Content Integration', () {
    ...
    group('Bot Message Processing', () {
      test('should process message with contentKey', () async {
        ...
        expect(processed.contentKey, equals('bot.acknowledge.completion.positive'));
      ...
      test('should preserve other message fields when processing contentKey', () async {
        final message = ChatMessage(
          id: 42,
          text: 'Original text',
          type: MessageType.bot,
    ...
    group('Choice Message Processing', () {
      test('should process choice message with contentKey', () async {
        ...
        expect(processed.choices![0].contentKey, equals('user.choose.task_status.completed'));
        expect(processed.choices![1].contentKey, equals('user.choose.task_status.failed'));
      ...
      test('should handle mixed choices (some with contentKey, some without)', () async {
        final message = ChatMessage(
          id: 1,
          text: '',
          type: MessageType.choice,
    ...
    group('Legacy Compatibility', () {
      test('should maintain backward compatibility with legacy variant system', () async {
        final message = ChatMessage(
          id: 1,
      ...
      test('should prioritize semantic content over legacy variants when contentKey present', () async {
        final message = ChatMessage(
          id: 1,
    ...
    group('Template Processing Integration', () {
      test('should apply template processing after semantic content resolution', () async {
        final message = ChatMessage(
          id: 1,
        ...
        expect(processed.text, isNot(equals('Fallback with {user.name|friend}')));
        expect(processed.text.isNotEmpty, isTrue);
      });
    });
    ...
    group('Performance and Caching', () {
      test('should cache content resolution for repeated requests', () async {
        ...
        final processed1 = await processor.processMessageTemplate(message, sequence);
        final processed2 = await processor.processMessageTemplate(message, sequence);
