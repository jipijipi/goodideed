  ...
  group('SequenceLoader', () {
    ...
    group('loadSequence', () {
      ...
      test('should build message map after loading sequence', () async {
        ...
        expect(
          sequenceLoader.messageMap.length,
          equals(sequence.messages.length),
        );
      ...
      test('should update currentSequence property', () async {
        ...
        expect(
          sequenceLoader.currentSequence!.sequenceId,
    ...
    group('loadChatScript', () {
      test(
        'should load default onboarding sequence for backward compatibility',
        () async {
    ...
    group('state management', () {
      test('should maintain state across multiple operations', () async {
        ...
        // Check message
        final hasMessage = sequenceLoader.hasMessage(
          originalSequence.messages.first.id,
        );
        expect(hasMessage, isTrue);

        // Get message
        final message = sequenceLoader.getMessageById(
          originalSequence.messages.first.id,
        );
    ...
    group('error handling', () {
      test('should handle malformed JSON gracefully', () async {
        ...
        expect(
          ...
          throwsA(
            predicate(
              (e) => e.toString().contains(ChatConfig.chatScriptLoadError),
            ),
          ),
        );
      });
