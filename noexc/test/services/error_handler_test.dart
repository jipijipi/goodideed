  ...
  group('ChatErrorHandler', () {
    group('Error Type Handling', () {
      test('should handle sequence load errors correctly', () {
        ...
        final exception = ChatErrorHandler.handleSequenceLoadError(
          'test_sequence',
          error,
        );
        ...
        expect(
          (exception as ChatSequenceException).type,
      ...
      test('should handle message processing errors', () {
        ...
        final exception = ChatErrorHandler.handleMessageProcessingError(
          123,
          error,
        );
      ...
      test('should handle template errors', () {
        ...
        final exception = ChatErrorHandler.handleTemplateError(
          '{invalid',
          error,
        );
      ...
      test('should handle condition errors', () {
        ...
        final exception = ChatErrorHandler.handleConditionError(
          'user.age > invalid',
          error,
        );
        ...
        expect(
          (exception as ChatConditionException).condition,
          'user.age > invalid',
        );
      ...
      test('should handle flow errors', () {
        ...
        final exception = ChatErrorHandler.handleFlowError(
          'Invalid route',
          error,
        );
      ...
      test('should handle asset validation errors', () {
        ...
        final exception = ChatErrorHandler.handleAssetValidationError(
          'sequence.json',
          error,
        );
