...
void main() {
  group('Task Boolean Computation Tests', () {
    ...
    group('isActiveDay Computation', () {
      ...
      test(
        'should return false when today is not in active days list',
        () async {
      ...
      test(
        'should update isActiveDay value on session initialization',
        () async {
          ...
          final secondResult = await userDataService.getValue<bool>(
            StorageKeys.taskIsActiveDay,
          );
    ...
    group('isPastDeadline Computation', () {
      ...
      test(
        'should update isPastDeadline value on session initialization',
        () async {
          ...
          final firstResult = await userDataService.getValue<bool>(
            StorageKeys.taskIsPastDeadline,
          );
