...
import '../../../lib/widgets/debug_panel/notification_debug_widget.dart';
import '../../../lib/widgets/debug_panel/debug_status_area.dart';
...
void main() {
  group('NotificationDebugWidget', () {
    ...
    testWidgets('should display error message when service locator is not initialized', (tester) async {
      await tester.pumpWidget(createWidget());
    ...
    testWidgets('should show loading indicator initially', (tester) async {
      ...
      final loadingText = find.text('Loading notification data...');
      
      // Either currently loading or has already completed
      expect(loadingIndicator.evaluate().isNotEmpty || find.textContaining('Error:').evaluate().isNotEmpty, isTrue);
    });

    testWidgets('should display error state when service locator not initialized', (tester) async {
      await tester.pumpWidget(createWidget());
    ...
    testWidgets('should display quick action buttons in error state', (tester) async {
      await tester.pumpWidget(createWidget());
    ...
    testWidgets('should handle null status controller gracefully', (tester) async {
    ...
    group('widget interaction', () {
      testWidgets('buttons should be available after loading completes', (tester) async {
        await tester.pumpWidget(createWidget());
        await tester.pumpAndSettle();
